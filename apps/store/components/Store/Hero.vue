...
function fadeSlideTo(target) {
  gsap.to(target, { opacity: 0.5, x: 300, yoyo: true, repeat: -1, duration: 2 })
}
...
onMounted(() => {
  fadeSlideTo('.fadeSlideTo')
  fadeSlideFrom('.fadeSlideFrom')
  fadeSlideFromTo('.fadeSlideFromTo')
})
</script>

<template>
  <div data-aos="fade-right" class="relative overflow-hidden bg-white">
            ...
            <div aria-hidden="true" class="pointer-events-none lg:absolute lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl">
              <div class="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                <div class="flex items-center space-x-6 lg:space-x-8">
                  ...
                  <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="https://tailwindui.com/img/ecommerce-images/home-page-03-hero-image-tile-03.jpg" alt="" class=" box fadeSlideFrom h-full w-full object-cover object-center">
                    </div>
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                  ...
                  <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                    ...
                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                      <img src="https://tailwindui.com/img/ecommerce-images/home-page-03-hero-image-tile-07.jpg" alt="" class="box fadeSlideTo h-full w-full object-cover object-center">
                    </div>
                  </div>
                </div>
              </div>
