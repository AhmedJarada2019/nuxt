...
<template>
  <NuxtLink
    ...
    :title="post.title"
  >
    <BlogPostImage data-aos="fade-right"
    ...
    <div class="px-4 py-4 flex flex-col flex-1">
      ...
      <h3  data-aos="fade-up-right" class="font-semibold text-lg mt-2 text-gray-800">
        {{ post.title }}
      </h3>
      <div  data-aos="fade-up-right" class="text-gray-500 text-sm mt-2 flex-1 line-clamp-3">
